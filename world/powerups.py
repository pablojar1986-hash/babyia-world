...
POWERUP_TYPES: dict[str, PowerupDef] = {
    "growth_crystal": PowerupDef(
        powerup_id="growth_crystal",   name="Cristal de Crecimiento",
        effect="increase_size",         value=0.5,  duration=0,
        description="Aumenta el tamano de BabyIA permanentemente en el episodio.",
        reward_delta=3.0,
    ),
    "speed_boots": PowerupDef(
        powerup_id="speed_boots",       name="Botas de Velocidad",
        effect="increase_speed",        value=0.5,  duration=50,
        description="Aumenta la velocidad temporalmente.",
        reward_delta=2.0,
    ),
    "shield_orb": PowerupDef(
        powerup_id="shield_orb",        name="Orbe de Escudo",
        effect="add_shield",            value=0.5,  duration=0,
        description="Agrega escudo protector temporal.",
        reward_delta=2.5,
    ),
    "fire_immunity": PowerupDef(
        powerup_id="fire_immunity",     name="Amuleto de Fuego",
        effect="fire_immunity",         value=1.0,  duration=0,
        description="Inmunidad al fuego en este episodio.",
        reward_delta=4.0,
    ),
    "poison_immunity": PowerupDef(
        powerup_id="poison_immunity",   name="Antivenenoso",
        effect="poison_immunity",       value=1.0,  duration=0,
        description="Inmunidad al veneno en este episodio.",
        reward_delta=4.0,
    ),
    "vision_light": PowerupDef(
        powerup_id="vision_light",      name="Luz de Vision",
        effect="increase_vision",       value=2.0,  duration=80,
        description="Aumenta el rango de vision.",
        reward_delta=2.0,
    ),
    "memory_crystal": PowerupDef(
        powerup_id="memory_crystal",    name="Cristal de Memoria",
        effect="increase_memory_focus", value=0.3,  duration=0,
        description="Aumenta la confianza de la memoria causal.",
        reward_delta=2.0,
    ),
    "energy_food": PowerupDef(
        powerup_id="energy_food",       name="Comida Energetica",
        effect="energy_restore",        value=0.5,  duration=0,
