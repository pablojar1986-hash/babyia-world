"""Fabrica de laberintos progresivos por nivel para BabyIA World 0.2.1."""
import json
from pathlib import Path

from config import DATA_DIR
from world.maze_generator import generate_solvable_maze, is_solvable

LEVEL_STATS_FILE = DATA_DIR / "level_stats.json"

# Paredes base del mundo 0.2 (niveles 0 y 1)
...
_CONFIGS: dict[int, tuple] = {
    0: (0.00,   0, "Tutorial", "mundo abierto sin paredes extra"),
    1: (0.00,   0, "Basico",   "paredes fijas del mundo base"),
    2: (0.15,  42, "Facil",    "laberinto ligero generado"),
    3: (0.20,  99, "Medio",    "laberinto moderado"),
    4: (0.25, 137, "Dificil",  "laberinto denso"),
    5: (0.30, 256, "Experto",  "laberinto complejo"),
    6: (0.35, 512, "Maestro",  "laberinto extremo"),
}
...
def get_maze_for_level(level: int) -> dict:
    ...
    Claves: walls (frozenset), seed, density, difficulty, solvable, description, wall_count.
    """
