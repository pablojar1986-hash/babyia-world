...
class TrainingMetrics:
    ...
    def _init_state(self):
        ...
        self.level_completed_count: int = 0
        self.next_level_door_attempts: int = 0
        self.next_level_door_successes: int = 0
        self.next_level_door_fails_no_key: int = 0
    ...
    def record_episode(
        ...
        world_id: str = "home",
        returned_home: bool = True,
        # 0.4 — estado corporal y causal
        powerups: int = 0,
        hazards: int = 0,
        hazards_blocked: int = 0,
        door_attempts: int = 0,
        door_successes: int = 0,
        causal_learned: int = 0,
        # 0.4.3 — puertas de nivel
        level_completed: bool = False,
        next_door_attempts: int = 0,
        next_door_successes: int = 0,
        next_door_fails_no_key: int = 0,
        ...
        # 0.4.3
        if level_completed:
            self.level_completed_count += 1
        self.next_level_door_attempts += next_door_attempts
        self.next_level_door_successes += next_door_successes
        self.next_level_door_fails_no_key += next_door_fails_no_key
    ...
    def to_dict(self) -> dict:
        return {
            ...
            # 0.4.3
            "level_completed_count": self.level_completed_count,
            "next_level_door_attempts": self.next_level_door_attempts,
            "next_level_door_successes": self.next_level_door_successes,
            "next_level_door_fails_no_key": self.next_level_door_fails_no_key,
            "optional_rooms_entered": self.optional_rooms_entered,
