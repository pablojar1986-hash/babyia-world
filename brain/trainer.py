...
class Trainer:
    ...
    def __init__(self, training: bool = True):
        ...
        self._maze_info: dict = {"difficulty": "Basico", "seed": 0,
                                  "solvable": True, "level": 0}
    ...
    def step(self):
        ...
        self.memory.record_step(self.episode, self.world.steps, state, action, reward, info)
    ...
    def end_episode(self, reached_goal: bool) -> int | None:
        ...
        phrase = self.memory.generate_phrase(
            self.episode, self._ep_reward,
            self._ep_walls, reached_goal, self.brain.epsilon,
            events=ev,
        )
