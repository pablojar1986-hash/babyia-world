...
ALL_WORLDS: dict[str, WorldDefinition] = {
    HOME_WORLD_ID: WorldDefinition(
        world_id=HOME_WORLD_ID,
        name="Casa de BabyIA",
        reward_profile="home",
        risk_level=0.0,
        complexity=1,
        home_return_required=False,
        min_level=0,
        description="Zona segura. Punto de partida y regreso.",
    ),
    FOOD_WORLD_ID: WorldDefinition(
        world_id=FOOD_WORLD_ID,
        name="Mundo de Comida",
        reward_profile="food",
        risk_level=0.2,
        complexity=1,
        home_return_required=True,
        min_level=0,
        description="Rico en comida. Baja dificultad.",
    ),
    DANGER_WORLD_ID: WorldDefinition(
        world_id=DANGER_WORLD_ID,
        name="Mundo de Peligro",
        reward_profile="danger",
        risk_level=0.8,
        complexity=3,
        home_return_required=True,
        min_level=1,
    ...
    CURIOSITY_WORLD_ID: WorldDefinition(
        world_id=CURIOSITY_WORLD_ID,
        name="Mundo de Curiosidad",
        reward_profile="curiosity",
        risk_level=0.4,
        complexity=2,
        home_return_required=True,
        min_level=2,
    ...
    CHALLENGE_WORLD_ID: WorldDefinition(
        world_id=CHALLENGE_WORLD_ID,
        name="Mundo Desafio",
        reward_profile="challenge",
        risk_level=0.6,
        complexity=4,
        home_return_required=True,
        min_level=3,
...
HOME_PORTALS: dict[str, Portal] = {
    ...
    "green_door": Portal(
        portal_id="green_door",
        target_world=CURIOSITY_WORLD_ID,
        label="Puerta Verde",
        required_level=2,
        position=(7, 6),
        color=(50, 200, 80),
    ...
    "gold_door": Portal(
        portal_id="gold_door",
        target_world=CHALLENGE_WORLD_ID,
        label="Puerta Dorada",
        required_level=3,
        position=(6, 7),
        color=(255, 200, 0),
